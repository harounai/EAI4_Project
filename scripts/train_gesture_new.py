...
#             image2.bmp
#             ...
#     other gestures repeated similarly...
# The "with" and "without" subfolders indicate whether the person is wearing an accessory (e.g. ring) or not
GESTURE_MAP = {
    "neutral": 0,
    "paper": 1,
    "rock": 2,
    ...
    for gesture_dir in sorted(data_dir.iterdir()):
        ...
        for accessory_dir in sorted(gesture_dir.iterdir()):
            ...
            for image_path in sorted(accessory_dir.glob("*.bmp")):
                ...
                rows.append({
                    "path": str(image_path),
                    "label": GESTURE_MAP[gesture_label],
                })
